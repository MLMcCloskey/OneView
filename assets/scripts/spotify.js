...
$("#homeButtons").on("click", "#bebopBtn", function(){
    $("#homeButtons").empty();
    $("#homeButtons").prepend(homeBtn + "<br>");
    $("#homeButtons").append('<iframe src="https://open.spotify.com/embed/user/1133747889/playlist/4vLG6mI0Wk7s4eMevdpsfq" width="300" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>');
});
...
$("#homeButtons").on("click", "#punkBtn", function(){
    $("#homeButtons").empty();
    $("#homeButtons").prepend(homeBtn + "<br>");
    $("#homeButtons").append('<iframe src="https://open.spotify.com/embed/user/spotify/playlist/37i9dQZF1DX3LDIBRoaCDQ" width="300" height="310" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>');
});
