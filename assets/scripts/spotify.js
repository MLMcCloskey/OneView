...
$("#homeButtons").on("click", "#swingJazz", function(){
    ...
    $("#homeButtons").append('<iframe src="https://open.spotify.com/embed/user/laemualda.taberna/playlist/6YUF8qV4sfXBa5Ct3W4ghX" width="300" height="100%" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>');
});

$("#homeButtons").on("click", "#coolJazz", function(){
    $("#homeButtons").empty();
    $("#homeButtons").prepend(homeBtn + "<br>");
    $("#homeButtons").append('<iframe src="https://open.spotify.com/embed/user/il_pelle/playlist/5K8NEGrH6nFT3ibvHWMXH4" width="300" height="100%" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>');
});

$("#homeButtons").on("click", "#bebopBtn", function(){
    $("#homeButtons").empty();
    $("#homeButtons").prepend(homeBtn + "<br>");
    $("#homeButtons").append('<iframe src="https://open.spotify.com/embed/user/ra%25C3%25BAlmoreno/playlist/6WYJwb0GNfQxjEcRior31d" width="300" height="100%" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>');
});
...
$("#homeButtons").on("click", "#electroswing", function(){
    $("#homeButtons").empty();
    $("#homeButtons").prepend(homeBtn + "<br>");
    $("#homeButtons").append('<iframe src="https://open.spotify.com/embed/user/foxolr/playlist/2FKWLIFub6K51sOmIfCseF" width="300" height="100%" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>');
});

$("#homeButtons").on("click", "#downtempo", function(){
    $("#homeButtons").empty();
    $("#homeButtons").prepend(homeBtn + "<br>");
    $("#homeButtons").append('<iframe src="https://open.spotify.com/embed/user/1166247682/playlist/32NRcLNr9FYhVxGFYwxHuE" width="300" height="100%" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>');
});

$("#homeButtons").on("click", "#studyBtn", function(){
    $("#homeButtons").empty();
    $("#homeButtons").prepend(homeBtn + "<br>");
    $("#homeButtons").append('<iframe src="https://open.spotify.com/embed/user/spotify/playlist/37i9dQZF1DWXLeA8Omikj7" width="300" height="100%" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>');
});
...
$("#homeButtons").on("click", "#indieBtn", function(){
    $("#homeButtons").empty();
    $("#homeButtons").prepend(homeBtn + "<br>");
    $("#homeButtons").append('<iframe src="https://open.spotify.com/embed/user/spotify/playlist/37i9dQZF1DX2Nc3B70tvx0" width="300" height="100%" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>');
});

$("#homeButtons").on("click", "#bluesBtn", function(){
    $("#homeButtons").empty();
    $("#homeButtons").prepend(homeBtn + "<br>");
    $("#homeButtons").append('<iframe src="https://open.spotify.com/embed/user/spotify/playlist/37i9dQZF1DXcnkReojaCnV" width="300" height="100%" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>');
});

$("#homeButtons").on("click", "#punkBtn", function(){
    $("#homeButtons").empty();
    $("#homeButtons").prepend(homeBtn + "<br>");
    $("#homeButtons").append('<iframe src="https://open.spotify.com/embed/user/spotify/playlist/37i9dQZF1DX3LDIBRoaCDQ" width="300" height="100%" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>');
});
